...
namespace api.aspnet4you.mvc5.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new AzureIdentityUser() { UserName = model.Email, Email = model.Email };
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                user = new AzureIdentityUser() { UserName = loginInfo.Email, Email = loginInfo.Email, Claims = loginInfo.ExternalIdentity.Claims.ToList() };
        ...
        public ActionResult SignOff()
        {
            ...
            return new JsonResult() { Data = isSuccessful };
        }
        ...
        private async Task SignInAsync(AzureIdentityUser user, bool isPersistent)
        {
            ...
            AuthenticationManager.SignIn(new AuthenticationProperties() { IsPersistent = isPersistent }, user.GenerateUserIdentityAsync(UserManager, user));
        }
